            ...
            <div className="flex-1 px-10 flex flex-col gap-10 justify-between">
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="w-5 h-5 rounded-full border border-2" style={{
                ...
                <div className="flex flex-row gap-10">
                    <button className="text-lg px-5 x-10 py-3 rounded-md flex flex-row justify-center items-center bg-gray-100" onClick={goBack}>
                        Cancelar
                    </button>
                    <Link className="bg-green-500 text-white text-lg w-full x-10 py-3 rounded-md flex flex-row justify-center items-center gap-3 hover:text-white" href={`https://api.whatsapp.com/send?phone=573053292703&text=Hola, me gustaría pedir el reloj de la marca ${product.brand}, con referencia ${product.reference}`} target="_blank">
