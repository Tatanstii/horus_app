...
export default function ProductCard({ id, images, authenticityLevel, name, price }: Props) {
    ...
    return <article className="w-full h-full rounded-md relative overflow-hidden group hover:cursor-pointer ">
        <Image src={firstImage} alt="Product" width={400} height={400} className="w-full object-cover object-center rounded-md group-hover:scale-110 hover:transition ease-linear duration-150" onClick={handleClick} />
